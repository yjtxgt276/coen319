...
/*numbers of cols, rows in a key matrix, number of rounds, and number of bytes in a block*/
#define Nbyte 16
#define Ncol 4
#define Nrow 4
#define Nrd 10
...
static uint8_t mix[Nrow][Ncol]={
0x02, 0x03, 0x01, 0x01,
0x01, 0x02, 0x03, 0x01,
0x01, 0x01, 0x02, 0x03,
0x03, 0x01, 0x01, 0x02};

static uint8_t invmix[Nrow][Ncol]={
0x0e, 0x0b, 0x0d, 0x09,
0x09, 0x0e, 0x0b, 0x0d,
0x0d, 0x09, 0x0e, 0x0b,
0x0b, 0x0d, 0x09, 0x0e};

static uint8_t sbox[256]={//SBOX from textbook
...
//inverse sbox for decrypt from textbook
